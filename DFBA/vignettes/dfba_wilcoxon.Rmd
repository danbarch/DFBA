...
\begin{equation}
  \begin{aligned}
    ...
    n_b &=\frac{3n-1}{4} -\frac{3T\_pos}{2(n+1)}.
  \end{aligned}
...
The final example is based on the following data taken from Chechile (2020) where there are more that two conditions within a block. The data are shown below. The first two conditions are *control* conditions and the third condition is an *experimental* condition.
