...
```{r}
dfba_beta_bayes_factor(a = median_test_results$a.post, 
                       b = median_test_results$b.post, 
                       method = "point", 
                       H0 = 14/15)
```
