...
#' @return \item{block.max}{The maximum size of a block effect; equal to the \code{block.max} argument}
...
#' 21 delta values, which range from 0 to \code{20*delta.step} where delta is the
